...
export interface AppSettings { theme: 'light' | 'dark' | 'system'; language: 'zh-CN' | 'en'; fimEnabled: boolean; exportDirectory: string; version?: number }
...
export interface CalendarEvent { id: string; title: string; startDate: string; endDate: string; startTime: string; endTime: string; allDay: boolean; description: string; color: string; priority: string; completed: boolean; reminder: Reminder | null; version?: number; createdAt: string; updatedAt: string }
export interface Todo { id: string; title: string; notes: string; listId: string | null; startAt: string | null; dueAt: string | null; priority: string; completedAt: string | null; reminder: Reminder | null; version?: number; createdAt: string; updatedAt: string }
export interface TodoList { id: string; name: string; color: string; version?: number; createdAt: string; updatedAt: string }
...
export interface BackgroundTask { id: string; kind: string; title: string; status: string; visibility?: 'user' | 'internal'; handlerVersion?: number; payload: BackgroundTaskPayload; publicMeta?: BackgroundTaskPayload; output: string; result: JsonValue | null; errorCode: string | null; errorMessage: string | null; conversationId: string | null; targetNoteId: string | null; resourceKey: string; modelProfileId: string | null; agentRunId: string | null; retryOf: string | null; scheduledAt?: string; attemptCount?: number; maxAttempts?: number; retryScheduled?: boolean; createdAt: string; startedAt: string | null; completedAt: string | null; updatedAt: string }
...
export interface ChatConversation { id: string; title: string; modelProfileId: string | null; mode: string; messageCount: number; preview: string; version?: number; createdAt: string; updatedAt: string }
export interface ChatMessage { id: string; conversationId: string; role: string; content: string; references: JsonValue[]; sources: JsonValue[]; proposalId: string | null; agentRunId: string | null; titleTaskId?: string | null; createdAt: string }
