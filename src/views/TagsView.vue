...
<style scoped>
.tags-workspace{display:grid;grid-template-columns:250px minmax(0,1fr);height:100%;background:var(--color-bg,#fff);color:var(--color-text,#242424)}
.tags-sidebar{padding:18px 12px;border-right:1px solid var(--color-border,#e6e6e6);background:#fafafa;overflow:auto}.tags-search{height:30px;display:flex;align-items:center;gap:8px;padding:0 10px;border:1px solid #dde1e6;background:#fff}.tags-search input{min-width:0;flex:1;border:0;outline:0;background:transparent;font:inherit}.tags-heading{display:flex;align-items:center;justify-content:space-between;margin:16px 8px 8px}.tags-heading strong{font-size:13px}.tags-heading button,.tag-actions button{border:0;background:transparent;display:inline-flex;align-items:center;gap:5px;height:28px;padding:0 8px;border-radius:4px}.tags-heading button:hover,.tag-actions button:hover{background:#eceef1}.tag-row{width:100%;height:32px;border:0;background:transparent;display:flex;align-items:center;gap:8px;padding:0 9px;border-radius:4px;text-align:left}.tag-row:hover{background:#f0f1f3}.tag-row.active{background:#e9edff;color:#315efb}.tag-row span{flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tag-row small{color:#858b94}.tags-main{min-width:0;overflow:auto;padding:44px 42px}.tags-main-header{display:flex;align-items:flex-end;justify-content:space-between;padding-bottom:20px;border-bottom:1px solid #ececec}.eyebrow{font-size:12px;color:#7d838c}.tags-main h1{font-size:28px;margin:5px 0 0}.tag-actions{display:flex;gap:6px}.tag-actions .danger{color:#c73c3c}.tagged-note-row{width:100%;border:0;border-bottom:1px solid #efefef;background:transparent;display:flex;align-items:center;gap:12px;padding:14px 8px;text-align:left}.tagged-note-row:hover{background:#fafafa}.tagged-note-copy{min-width:0;flex:1;display:grid;gap:4px}.tagged-note-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tagged-note-copy small,.tagged-note-row time{font-size:12px;color:#818792}.remove-link{opacity:0;color:#bc3a3a}.tagged-note-row:hover .remove-link{opacity:1}.tags-empty{display:grid;place-items:center;gap:7px;color:#9ba1aa;padding:100px 20px}.tags-empty p{margin:4px 0 0;color:#5f6670}.tag-picker-backdrop{position:fixed;inset:0;z-index:200;background:rgba(25,28,34,.28);display:grid;place-items:center}.tag-picker{width:min(520px,calc(100vw - 40px));max-height:70vh;background:#fff;border:1px solid #ddd;box-shadow:0 18px 50px rgba(0,0,0,.16);display:grid;grid-template-rows:auto auto minmax(0,1fr) auto;gap:14px;padding:18px}.tag-picker header,.tag-picker footer{display:flex;align-items:center;justify-content:space-between}.tag-picker h2{margin:0 0 3px;font-size:18px}.tag-picker header button{border:0;background:transparent;font-size:22px}.tag-picker-list{overflow:auto;border-block:1px solid #eee}.tag-picker-list label{display:flex;gap:10px;padding:11px 5px;border-bottom:1px solid #f1f1f1}.tag-picker-list label span{display:grid;gap:3px}.tag-picker-list small{color:#858b94}.tag-picker footer{justify-content:flex-end;gap:8px}.tag-picker footer button{height:32px;padding:0 14px;border:1px solid #d9d9d9;background:#fff}.tag-picker footer .primary{background:#315efb;color:#fff;border-color:#315efb}.tag-picker footer .primary:disabled{opacity:.45}@media(max-width:760px){.tags-workspace{grid-template-columns:190px 1fr}.tags-main{padding:28px 20px}}
