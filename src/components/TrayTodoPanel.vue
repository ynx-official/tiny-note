...
import { CalendarDays, Check, ChevronDown, ClipboardList, Inbox, ListTodo, LoaderCircle, Plus, Settings } from 'lucide-vue-next'
...
<template>
  <main class="tray-todo-panel">
    ...
    <footer class="tray-panel-nav">
      <button type="button" class="active" :title="t('todos')" @click="openMain('/todos')"><ClipboardList :size="21" /></button>
...
<style scoped>
:global(html.tray-panel-root),:global(body.tray-panel-body),:global(body.tray-panel-body #app){width:100%;height:100%;min-width:0;min-height:0;overflow:hidden;background:var(--bg-primary)}
.tray-todo-panel{width:100%;height:100%;display:flex;flex-direction:column;overflow:hidden;border:1px solid color-mix(in srgb,var(--border-color),#000 6%);border-radius:16px;background:color-mix(in srgb,var(--bg-primary) 97%,transparent);color:var(--text-primary);box-shadow:0 18px 55px rgba(0,0,0,.18);font-size:13px}
.tray-panel-header{position:relative;flex:none;height:70px;display:flex;align-items:center;justify-content:space-between;padding:9px 22px 0}.tray-list-picker{position:relative;min-width:0}.tray-list-trigger{max-width:290px;height:42px;display:flex;align-items:center;gap:7px;border-radius:9px;padding:0 5px;font-size:24px;font-weight:700;letter-spacing:-.03em}.tray-list-trigger span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tray-list-trigger svg{flex:none;color:var(--text-secondary)}.tray-list-trigger:hover,.tray-open-full:hover{background:var(--bg-hover)}.tray-open-full{width:36px;height:36px;display:grid;place-items:center;border-radius:9px;color:var(--text-secondary)}
.tray-list-menu{position:absolute;z-index:20;left:0;top:44px;width:230px;max-height:250px;overflow:auto;display:grid;gap:2px;padding:5px;border:1px solid var(--border-color);border-radius:10px;background:var(--bg-primary);box-shadow:0 14px 38px rgba(0,0,0,.17)}.tray-list-menu button{height:36px;display:grid;grid-template-columns:18px minmax(0,1fr) 18px;align-items:center;gap:8px;padding:0 9px;border-radius:7px;text-align:left}.tray-list-menu button:hover{background:var(--bg-hover)}.tray-list-menu button>span:nth-child(2){overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tray-list-dot{width:10px;height:10px;border-radius:4px;justify-self:center}
.tray-quick-add{height:48px;flex:none;display:flex;align-items:center;gap:8px;margin:9px 22px 10px;padding:0 15px;border:1px solid transparent;border-radius:12px;background:var(--bg-secondary);color:var(--text-secondary);transition:.15s}.tray-quick-add:focus-within{border-color:color-mix(in srgb,var(--accent-color),transparent 35%);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent-color),transparent 84%)}.tray-quick-add input{min-width:0;flex:1;border:0;outline:0;background:transparent;color:var(--text-primary);font-size:13px}.tray-quick-add input::placeholder{color:var(--text-tertiary)}
.tray-panel-error{flex:none;margin:0 24px 7px;color:#dc4c4c;font-size:11px}.tray-todo-scroll{min-height:0;flex:1;overflow:auto;padding:0 14px 14px}.tray-todo-scroll::-webkit-scrollbar{width:5px}.tray-todo-scroll::-webkit-scrollbar-thumb{border-radius:5px;background:var(--border-color)}.tray-todo-rows{display:grid}.tray-todo-row{min-height:46px;display:grid;grid-template-columns:40px minmax(0,1fr);align-items:start;border-radius:9px}.tray-todo-row:hover{background:var(--bg-hover)}.tray-check{width:40px;height:44px;display:grid;place-items:center}.tray-check>span{width:18px;height:18px;display:grid;place-items:center;border:1.5px solid var(--text-tertiary);border-radius:6px;color:#fff;transition:.14s}.tray-check:hover>span{border-color:var(--accent-color);background:var(--accent-light)}.tray-check.checked>span{border-color:var(--accent-color);background:var(--accent-color)}.tray-row-main{min-width:0;min-height:44px;display:flex;align-items:center;gap:9px;padding:0 10px 0 0;text-align:left}.tray-row-main strong{min-width:0;flex:1;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:520}.tray-row-main small{flex:none;color:var(--text-tertiary);font-size:11px}.tray-row-main small.overdue{color:#e5484d}.tray-todo-rows.completed{opacity:.54}.tray-todo-rows.completed .tray-row-main strong{text-decoration:line-through}
.tray-completed{margin-top:8px}.tray-section-heading{width:100%;height:36px;display:flex;align-items:center;gap:6px;padding:0 8px;color:var(--text-secondary);text-align:left}.tray-section-heading svg{transition:.15s}.tray-section-heading svg.collapsed{transform:rotate(-90deg)}.tray-section-heading span{font-weight:600}.tray-section-heading small{margin-left:2px}.tray-panel-state,.tray-panel-empty{min-height:150px;display:flex;align-items:center;justify-content:center;gap:8px;color:var(--text-secondary)}.tray-panel-empty{flex-direction:column;text-align:center}.tray-panel-empty svg{color:var(--accent-color)}.tray-panel-empty strong{color:var(--text-primary);font-size:14px}.tray-panel-empty span{font-size:11px}
.tray-panel-nav{height:58px;flex:none;display:grid;grid-template-columns:repeat(3,1fr);align-items:center;border-top:1px solid var(--border-color);background:color-mix(in srgb,var(--bg-primary) 97%,transparent)}.tray-panel-nav button{width:42px;height:38px;display:grid;place-items:center;justify-self:center;border-radius:10px;color:var(--text-tertiary)}.tray-panel-nav button:hover{background:var(--bg-hover);color:var(--text-primary)}.tray-panel-nav button.active{color:var(--accent-color)}
