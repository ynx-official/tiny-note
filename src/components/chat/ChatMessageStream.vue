...
import { ChevronDown, Copy, FileText, Save, Wrench, X } from 'lucide-vue-next'
...
const {
  ...
  respondInput, streamingText, error, router, savedNote, openSavedNote, rememberReadingPosition
} = workspace
</script>

<template>
  <main ref="messagesRef" class="chat-page-messages" aria-live="polite" @scroll.passive="rememberReadingPosition">
    ...
    <ChatApprovalCard :workspace="workspace" />
