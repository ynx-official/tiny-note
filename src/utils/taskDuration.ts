...
export function taskDurationMs(task: Partial<BackgroundTask> | null | undefined, now = Date.now()) {
...
export function formatTaskDuration(task: Partial<BackgroundTask> | null | undefined, now = Date.now()) {
