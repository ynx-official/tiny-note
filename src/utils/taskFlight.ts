function taskCenterTarget() {
  return globalThis.document.querySelector<HTMLElement>('[data-task-center-target]')
}
...
export function prepareTaskFlight(sourceElement: EventTarget | null | undefined): () => void {
  if (!(sourceElement instanceof globalThis.HTMLElement)) return () => pulseTaskCenter()
