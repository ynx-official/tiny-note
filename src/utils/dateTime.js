...
export function compareLocalEventTimes(form) {
...
export function endOneHourAfter(startDate, startTime) {
...
export function shiftEventStart(form, startDate, startTime) {
