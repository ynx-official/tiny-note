...
- Given Mermaid 图表较宽，When 使用行内 75%–250% 手动缩放、适合宽度或全屏查看，Then 100% 保持 SVG 原始比例、适宽可给出全图概览、图表保持矢量清晰且滚动只发生在图表舞台内；全屏可在 10%–250% 间查看，按住鼠标左键可拖动画布，滚轮围绕鼠标指向的位置缩放；Esc 可关闭全屏并恢复焦点。
